...
#include <sys/time.h>
#include "types.h"
#include <map>  // To associate function name to times
#include <profiler.h> // Simple timer Class
#define NDEBUG
#include <assert.h>
...
double * LineSegmentDetection( int * n_out,
                               ...
                               int n_bins,
                               int ** reg_img, int * reg_x, int * reg_y, Profiler* prof);
...
double * lsd_scale_region( int * n_out,
                           float * img, int X, int Y, double scale,
...
double* LineSegmentDetection_gradient(int *n_out, float *img,
                              EyeMARS::Matrix2d<short> &sobel,
                              int X, int Y,
                              double scale, double sigma_scale, double quant,
                              double ang_th, double log_eps, double density_th,
